...
function FilmFestival() {
  ...
  const getSomeRequest = async (request) => {
    const data = await fetchWrapper.get(`../api/festival?request=${request}`);
    if (data) {
                ...
                <Row className="align-items-center mt-2">
                  <Col>
                    <Form>
                      <div className="form-row">
                        <Col className="mb-3 p-0 text-left ">
                          <div className="mb-1">URL Image Background</div>

                          <Input
                            disabled
                            type="text"
                            defaultValue={`${resultBackground.url_imageOrigin}`}
                          />
                        </Col>
                      </div>
                    </Form>
                ...
                <Row className="align-items-center mt-2">
                  <Col>
                    <Form>
                      <div className="form-row">
                        <Col className="mb-3 p-0 text-left ">
                          <div className="mb-1">URL Image</div>
      ...
      >
        <div className="justify-content-center text-center p-4">
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5>Header Image Page Film Festival</h5>
                <Input
                  type="text"
                  defaultValue={`${resultHeader.url_imageOrigin}`}
                  onChange={(e) => {

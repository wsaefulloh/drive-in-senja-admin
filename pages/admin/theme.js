...
// core components
import CardGenre from "components/Cards/CardsTheme.js";
...
function ThemePage() {
  ...
  const getAllTheme = async () => {
    const data = await fetchWrapper.get(`../api/theme`);
    if (data) {
      setTheme(data.data);
    }
  };
    ...
    <>
            ...
            <Container>
              <div className="py-3">
                <Row className="align-items-center">
                  <Col>
                    <h3 className="mb-0">List Theme</h3>
                  </Col>
                  <Button
      ...
      >
        <div className="justify-content-center text-center p-4">
          ...
          ></img>
          <h3 className="m-0 mb-3 p-0">Tambah Theme</h3>
          <Form>

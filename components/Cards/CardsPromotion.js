...
function CardPromotion(props) {
  let { id, title, description, poster_image, status_active } = props;
            ...
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">
                  URL Google Drive Image Event & Promotion (386 x 386)
                </h5>
                <Input
                  type="text"
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                ...
                <Input
                  type="text"
                  defaultValue={`${newData.status_active}`}
                  onChange={(e) => {

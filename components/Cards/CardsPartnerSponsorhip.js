...
function CardPartnerSponsorhip(props) {
  let { id, url_image, name_partner, url_partner } = props;
      ...
      <Card className="mb-2">
        <div className="py-3 px-2">
          <Row className="align-items-center">
            <Col>
              <span className="mb-0">{name_partner}</span>
            </Col>
            <Button
      ...
      >
        <div className="justify-content-center text-center p-4">
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                ...
                <Input
                  type="text"
                  defaultValue={`${newData.name_partner}`}
                  onChange={(e) => {
                    setNewData({
                      ...newData,
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">URL Partner</h5>
                <Input
                  type="text"
                  defaultValue={`${newData.url_partner}`}
                  onChange={(e) => {
                    setNewData({
                      ...newData,
...
CardPartnerSponsorhip.propTypes = {
  id: PropTypes.any,
  url_image: PropTypes.any,
  name_partner: PropTypes.any,
  url_partner: PropTypes.any,
};

export default CardPartnerSponsorhip;

...
function CardWorkshop(props) {
  let { id, url_image, name_workshop, url_form, description } = props;

  const [loading, setLoading] = useState(false);
  const [modalOpen, setModalOpen] = useState(false);
  const [newData, setNewData] = useState({
    id: `${id}`,
    name_workshop: `${name_workshop}`,
    url_image: `${url_image}`,
    url_form: `${url_form}`,
      ...
      <Card className="mb-2">
        <div className="py-3 px-2">
          <Row className="align-items-center">
            <Col>
              <span className="mb-0">{name_workshop}</span>
            </Col>
            <Button
      ...
      >
        <div className="justify-content-center text-center p-4">
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                ...
                <Input
                  type="text"
                  defaultValue={`${newData.name_workshop}`}
                  onChange={(e) => {
                    setNewData({
                      ...newData,
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">URL Google Drive Image Workshop</h5>
                <Input
                  type="text"
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">Link Pendaftaran Workshop</h5>
                <Input
                  type="text"
                  defaultValue={`${newData.url_form}`}
                  onChange={(e) => {
                    setNewData({
                      ...newData,
...
CardWorkshop.propTypes = {
  ...
  name_workshop: PropTypes.any,
  url_form: PropTypes.any,

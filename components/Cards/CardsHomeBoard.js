...
function CardHomeBoard(props) {
  let { id, title, description, url } = props;
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const deleteThis = async (id) => {
          try {
            const response = await fetch(`../api/home-board?id=${id}`, {
              method: "DELETE",
            });
      ...
      >
        <div className="justify-content-center text-center p-4">
          ...
          <Form>
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">Description</h5>
                <Input
                  type="text"
            ...
            <div className="form-row">
              <Col className="mb-3 p-0 text-left ">
                <h5 className="pl-1 mb-1">
                  URL Google Drive Image (399 x 266)
                </h5>
                <Input
                  type="text"
